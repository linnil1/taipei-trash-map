...
<InfoCard title="Privacy Policy">
	...
	<InfoCardText title="3. Third-party">
		Our website uses third-party services such as Google Maps API. These services may collect their
		own data according to their privacy policies. Please refer to <a
